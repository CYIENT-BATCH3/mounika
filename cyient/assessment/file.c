...
Algorithm:
statrt.
Create a text file to open the file in the cansole window.
use fopen command to open the file and use 'w' command to write a any information in the cansole.
check the text file if the entered information is updated or not.
stop.
